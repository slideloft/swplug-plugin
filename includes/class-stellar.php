...
class SWPlug {
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_swplug_send_order_notification', $plugin_public , 'swplug_send_order_notification' );
	    $this->loader->add_action( 'wp_ajax_nopriv_swplug_send_order_notification', $plugin_public , 'swplug_send_order_notification' );
